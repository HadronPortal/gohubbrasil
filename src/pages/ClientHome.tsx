  ...
  return (
    ...
    >
      ...
      <div className="px-1.5 pt-2">
        <p className="text-[12px] font-semibold text-[#172033] truncate mt-0.5">{shop.name}</p>
        ...
        <section id="ultimas-lojas" className="mt-6">
          ...
          {loadingShops ? (
            <div className="flex gap-3 overflow-hidden px-4">
              {[1, 2, 3].map((i) => (
                <Skeleton key={i} className="h-36 w-[108px] flex-shrink-0 rounded-[8px]" />
              ))}
            </div>
            ...
            <div className="flex gap-3 overflow-x-auto px-4 pb-2 snap-x snap-mandatory scroll-px-4">
