          ...
          <CardContent className="px-8 pb-10 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button 
                ...
                className="h-11 border-gray-200 hover:bg-blue-50 hover:border-blue-200 text-gray-600 gap-2"
              >
              ...
              <Button 
                ...
                className="h-11 border-gray-200 hover:bg-red-50 hover:border-red-200 text-gray-600 gap-2"
              >
